...
class DomainApi(object):
    ...
    def delete_domain_with_http_info(self, domain_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api2/v1/domains/{domainId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_domains_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'page_number' in params and params['page_number'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_number` when calling `list_domains`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'page_size' in params and params['page_size'] > 50:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_domains`, must be a value less than or equal to `50`")  # noqa: E501
        if 'page_size' in params and params['page_size'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_domains`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_domain(self, domain_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_domain_with_http_info(domain_id, **kwargs)  # noqa: E501
            return data
